...
class YahooClient
{
   ...
   // }
    ...
    public function createAuthUrl()
    {
        ...
        $url = YahooClient::AUTH_ENDPOINT . "?client_id=" . $this->client_id . "&scope=" . urlencode($this->scope ?? '') . "&nonce=" . $this->nonce . "&response_type=code&redirect_uri=". $this->redirect_url ;
